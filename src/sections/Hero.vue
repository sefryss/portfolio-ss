...
<template>
  ...
  >
    ...
    ></div>
    <div
      class="absolute bottom-44 -left-64 h-[150px] w-[900px] -rotate-45 rounded-3xl bg-gradient-to-r from-violet-600 to-indigo-800 opacity-30 dark:opacity-30 blur-3xl filter block lg:bottom-24 lg:-left-20 lg:h-28 lg:w-[250px] lg:-rotate-12 dark:lg:opacity-20 lg:opacity-30 xl:h-40 xl:w-[400px]"
    ></div>
    <div
      class="absolute left-[28%] top-28 hidden rotate-12 rounded-3xl bg-sky-800 blur-3xl filter opacity-20 dark:opacity-30 lg:h-32 lg:w-[450px] lg:block xl:h-44 xl:w-[600px]"
    ></div>
    ...
    >
      ...
      >
        <a
          href="https://github.com/sefryss"
          target="_blank"
          class="group flex items-center space-x-3"
        >
          <img
            class="w-[1.5rem] md:w-[1.7rem]"
